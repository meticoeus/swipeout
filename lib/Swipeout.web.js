...
var Swipeout = function (_React$Component) {
  ...
  function Swipeout(props) {
    ...
    _this.setContentRef = _this.setContentRef.bind(_this);
  ...
  Swipeout.prototype.setContentRef = function setContentRef(el) {
    this.content = el;
  };

  Swipeout.prototype.handleClickContent = function handleClickContent(e) {
    if (this.openedLeft || this.openedRight) {
      e.stopPropagation();
      this.close();
    }
  ...
  Swipeout.prototype._setStyle = function _setStyle(value) {
    ...
    var limit = value === 0 ? 0 : value > 0 ? this.btnsLeftWidth : -this.btnsRightWidth;
  ...
  Swipeout.prototype.renderButtons = function renderButtons(buttons, name, style) {
    var _this3 = this;
    ...
    return buttons && buttons.length ? _react2["default"].createElement(
      'div',
      { className: prefixCls + '-actions ' + prefixCls + '-actions-' + name, style: style },
  ...
  Swipeout.prototype.render = function render() {
    ...
    return left.length || right.length ? _react2["default"].createElement(
      ...
      _react2["default"].createElement('div', { className: prefixCls + '-cover', onClick: this.handleClickContent, style: this.state.coverStyle }),
      ...
      _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          'div',
          { className: prefixCls + '-content', ref: this.setContentRef, style: this.state.contentStyle },
          children
        )
      )
    ) : _react2["default"].createElement(
      'div',
      _extends({ ref: this.setContentRef }, divProps),
      children
    );
  };
