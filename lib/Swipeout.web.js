...
var Swipeout = function (_React$Component) {
  ...
  function Swipeout(props) {
    ...
    _this.setCoverRef = _this.setCoverRef.bind(_this);
    _this.setLeftRef = _this.setLeftRef.bind(_this);
    _this.setRightRef = _this.setRightRef.bind(_this);
  ...
  Swipeout.prototype.setCoverRef = function setCoverRef(el) {
    this.cover = el;
  };

  Swipeout.prototype.setLeftRef = function setLeftRef(el) {
    this.left = el;
  };

  Swipeout.prototype.setRightRef = function setRightRef(el) {
    this.right = el;
  };
  ...
  Swipeout.prototype.render = function render() {
    ...
    return left.length || right.length ? _react2["default"].createElement(
      ...
      _react2["default"].createElement('div', { className: prefixCls + '-cover', ref: this.setCoverRef, onClick: this.handleClickContent }),
